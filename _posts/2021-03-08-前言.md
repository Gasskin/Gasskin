...
在[这个](https://github.com/ssloy/tinyrenderer/tree/909fe20934ba5334144d2c748805690a1fa4c89f)仓库下载下来，里面两个文件是作为我们绘制的库进行使用，把他们丢到你新建的VS项目中，然后通过VS导入

![1](https://www.logarius.icu/images/SoftwareRender/1.png)

最终你的项目应该如此

![2](https://www.logarius.icu/images/SoftwareRender/2.png)
...
![3](https://www.logarius.icu/images/SoftwareRender/3.png)
