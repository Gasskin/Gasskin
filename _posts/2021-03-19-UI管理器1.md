...
![1](https://www.logarius.icu/images/SimpleGameFramework/UI/1.png)
...
![1](https://www.logarius.icu/images/SimpleGameFramework/UI/2.png)

然后，我们再给它多增加三个节点，分别作为对应UI的挂在节点

![1](https://www.logarius.icu/images/SimpleGameFramework/UI/3.png)
...
![1](https://www.logarius.icu/images/SimpleGameFramework/UI/4.png)
...
![1](https://www.logarius.icu/images/SimpleGameFramework/UI/5.png)
...
![1](https://www.logarius.icu/images/SimpleGameFramework/UI/6.png)
...
![1](https://www.logarius.icu/images/SimpleGameFramework/UI/8.png)

**强调一下，制作UI的时候我们不需要再次设置一个Canvas！因为已经有统一的UIRoot了！如图，我们只需要在对应的节点下面制作就行，比如现在，我们就可以把TestUI做成一个预制体！！然后把他从UIRoot中删除！！**

![1](https://www.logarius.icu/images/SimpleGameFramework/UI/9.png)
...
![1](https://www.logarius.icu/images/SimpleGameFramework/UI/10.png)
