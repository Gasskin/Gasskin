...
![1](https://www.logarius.icu/images/SoftwareRender/3/1.png)

想象一下，假设我们现在是从正面在看这张图，那么如果我们从顶部来看，俯视的看，会是什么样的情况？可能很抽象，尽可能的想象一下，应该是如此，我们看到的应该是图中我画出来的那一条线段。

![1](https://www.logarius.icu/images/SoftwareRender/3/2.png)
...
![1](https://www.logarius.icu/images/SoftwareRender/3/3.png)
...
![1](https://www.logarius.icu/images/SoftwareRender/3/4.png)
...
![1](https://www.logarius.icu/images/SoftwareRender/3/5.png)
...
![1](https://www.logarius.icu/images/SoftwareRender/3/6.png)
...
![1](https://www.logarius.icu/images/SoftwareRender/3/7.png)
...
![1](https://www.logarius.icu/images/SoftwareRender/3/8.png)

好了，现在问题就变成了，怎么求三角形的面积？利用向量的叉积...

![1](https://www.logarius.icu/images/SoftwareRender/3/9.png)

具体原理就不在这里解释了，总之，结论是三角形ABC的面积等于

![1](https://www.logarius.icu/images/SoftwareRender/3/10.png)
...
![1](https://www.logarius.icu/images/SoftwareRender/3/11.png)
...
![1](https://www.logarius.icu/images/SoftwareRender/3/12.png)

我们现在只是在求三角形的面积，所以这里的ABC三个点是二维的，我们不需要他们的Z值

那么可以得到

![1](https://www.logarius.icu/images/SoftwareRender/3/13.png)

你会发现这就是上面叉乘结果的Z值！不过是相反的，但是向量叉积的正负只是代表了方向，对于二维三角形来说，这是没有意义的，咱们可以取绝对值，这就代表了三角形的总面积！即 Z = AC x AB

同理，咱们再看看res的X值和Y值

![1](https://www.logarius.icu/images/SoftwareRender/3/14.png)
...
![1](https://www.logarius.icu/images/SoftwareRender/3/15.png)
