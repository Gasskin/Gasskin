...
这个模块本身是很好理解的，但目前我也不是很清楚具体会应用在什么地方，参照UGF的描述，一些用于状态切换的游戏逻辑，是可以写在这个模块的。当然，我们后面还有一个流程管理模块Process，这个模块就是基于状态机的再封装，也算是一个应用。

咱们新建如下脚本

![1](https://www.logarius.icu/images/SimpleGameFramework/Fsm/1.png)
