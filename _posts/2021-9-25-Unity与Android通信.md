...
![1](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\1.png)

下面配置可以随便写，不会用到，但还是规范一点吧！

![1](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\2.png)
...
![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\7.png)

![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\8.png)

然后我们把创建工程自带的app module删掉，当然直接删是删不掉的，得在这

![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\10.png)

同事删除MySDK的所有依赖

![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\11.png)

删除安卓自带的一些资源文件，只留下main就好

![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\16.png)
...
![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\12.png)

这其中有2个文件夹，得看你的UNITY项目选择打包成mono还是il2cpp，这里我们选择mono，则继续往下找

![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\13.png)

将他复制到AS对应目录，并添加为Library

![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\14.png)

![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\15.png)

在main目录中的package中创建一个JAVA类，集成自Fragment，有同名类，注意命名空间

![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\17.png)
...
![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\18.png)

![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\21.png)

### Unity层

用解压缩软件打开arr，删除两个东西

![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\19.png)

![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\20.png)

新建一个测试场景

![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\22.png)
...
<img src="D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\23.png" alt="3" style="zoom:50%;" />

打包设置，公司名必须改一个，使用默认的可能打包出错

![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\24.png)

这两个需要和安卓那边设置一样，不一样好像也可以，没有过多测试，目前先保持一致！

![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\25.png)

打包，测试

![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\26.png)
...
![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\3.png)

这里分两种情况，如果你之前曾经设置过代理，哪怕你取消了，仍然会有残留配置，检查gradle.properties，图中红框内应该会有对应的代理信息，删掉

![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\4.png)
...
![3](D:\__Project\Gasskin\images\UnityStudy\Unity与Android通信\5.png)
