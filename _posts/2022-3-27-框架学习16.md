...
{
    // 配置文件的保存路径，以及配置文件的名称
    public const string configPath = "Assets/Resources";
    public const string configName = "AssetBundleConfig";
...
![image-20220403150705099](C:\Users\Logarius\AppData\Roaming\Typora\typora-user-images\image-20220403150705099.png)
